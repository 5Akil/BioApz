...
// Create Event
exports.ComboCalendarCreate = async (req, res) => {
	...
	var requiredFields = _.reject(['business_id', 'title', 'description', 'repeat_every', 'end_date', 'start_date', 'location'], (o) => { return _.has(data, o) })
